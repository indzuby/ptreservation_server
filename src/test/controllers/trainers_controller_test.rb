...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, trainer: { company_id: @trainer.company_id, is_delete: @trainer.is_delete, user_id: @trainer.user_id }
    end
  ...
  test "should update trainer" do
    patch :update, id: @trainer, trainer: { company_id: @trainer.company_id, is_delete: @trainer.is_delete, user_id: @trainer.user_id }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
